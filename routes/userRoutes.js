...
const { loginUser, registerUser, changePass, updateDetails, getUser, getUsers, removeUser, resetPass, email, exportStudents } = require('../controller/userController');
...
router.get('/students/download', exportStudents);
